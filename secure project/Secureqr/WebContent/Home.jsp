...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="biDashboardDropdown">
                        <a class="dropdown-item" href="encryption.jsp">Encryption</a>
                        <a class="dropdown-item" href="decryptqr.jsp">Decryption</a>
                    </div>
                </li>    
                <li class="nav-item">
    ...
    <footer class="bg-light text-center text-lg-start mt-5">
        <div class="container p-4">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <a href="mailto:info@logisticsco.com" class="text-dark">info@encryptco.com</a>
                        </li>
                        <li>
        ...
        <div class="text-center p-3 bg-dark text-white">
            &copy; 2024 encryptCo. All rights reserved.
        </div>
    </footer>
